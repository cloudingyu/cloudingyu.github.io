...
**关键词**：Cache 一致性、监听协议（Snooping）、写失效（Write-invalidate）、写更新（Write-update）、MSI 协议（Modified-Shared-Invalid）、MESI 协议（Modified-Exclusive-Shared-Invalid）、虚假共享（False Sharing）、Bus Read Exclusive、Cache-to-Cache Transfer、状态迁移、总线事务
