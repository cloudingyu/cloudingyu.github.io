...
$$
P(y|x) = \frac{1}{\sqrt{2\pi\sigma^2}} \exp\left(-\frac{(y - t)^2}{2\sigma^2}\right)
$$

$$
\begin{aligned}
-\ln P(y|x) =& - \ln \left[ \frac{1}{\sqrt{2\pi\sigma^2}}  \exp \left( -\frac{(y - t)^2}{2\sigma^2} \right)\right]\\
=& \frac{1}{2\sigma^2} (y - t)^2 -\ln\frac{1}{\sqrt{2\pi\sigma^2}}
\end{aligned}
$$
