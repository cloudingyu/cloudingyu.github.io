...
public class Console {
    ...
    public Command commandParser(String newCommand){
    ...
    public static void main(String[] args) {
        ...
        while (running) {
            ...
            try{
                Command command = commandParser(newCommand);
...
InsertCommand --> StringBuffer
DeleteCommand --> StringBuffer
Client --> Command
Client --> StringBuffer
Client --> EditorInvoker
