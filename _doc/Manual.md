...
```yml
# Site settings
title: CY Blog             # title of your website
SEOTitle: CY Blog          # check out docs for more detail
description: "Cool Blog"    # ...

# SNS settings      
github_username: cloudingyu     # modify this account to yours
weibo_username: cloudingyu      # the footer woule be auto-updated.
...
sidebar-avatar: /img/avatar-cy.jpg     # use absolute URL.
```
...
It's possible that you want the two things different. For me, my site-title is **“CY Blog”** but I want the title shows in search engine is **“黄玄的博客 | CY Blog”** which is multi-language.
...
- Fixed [issue#15](https://github.com/CYpro/cloudingyu.github.io/issues/15) about code wrap.
